...
from pydantic2 import BaseModel, ImportString, ValidationError
...
```py
from pydantic2 import ValidationError, dataclasses
...
from pydantic2 import BaseModel, FutureDate, ValidationError
...
from pydantic2 import BaseModel, PastDate, ValidationError
...
from pydantic2 import BaseModel, FutureDatetime, ValidationError
...
from pydantic2 import AwareDatetime, BaseModel, ValidationError
...
from pydantic2 import BaseModel, PastDatetime, ValidationError
...
```py
from pydantic2 import BaseModel, Json, ValidationError
...
```py
from pydantic2 import ConfigDict, ValidationError, dataclasses
...
from pydantic2 import BaseModel, NaiveDatetime, ValidationError
...
```py
from pydantic2 import AnyUrl, BaseModel, ValidationError
...
```py
from pydantic2 import BaseModel, Field, HttpUrl, ValidationError
...
```py
from pydantic2 import UUID5, BaseModel, ValidationError
